...
Local installation of Gradle 1.7 is recommended. Use the bundled gradle wrapper script (@gradlew@) if no Gradle 1.7 installation is present. @gradlew.bat@ is the equivalent Windows version.
